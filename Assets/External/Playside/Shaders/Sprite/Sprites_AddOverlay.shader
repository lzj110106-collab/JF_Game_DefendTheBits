Shader "PlaySide/Sprites/AddOverlay"
{
	Properties
	{
		...
		_OverColor ("Overlay Color", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				fixed4 over = tex2D (_OverTex, IN.texcoord.zw) * _OverColor;
				c.rgb += over.rgb*over.a;// + (1-IN.texcoord.y)*0.35;
				c.rgb *= c.a;
