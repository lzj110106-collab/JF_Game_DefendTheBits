...
namespace PigeonCoopToolkit.Effects.Trails
{
    public abstract class TrailRenderer_Base : MonoBehaviour
    {
		...
		public float EmitVelocityX = 0;
		[HideInInspector] public float ScaleMultiplier = 1;

        public bool _pause;                                         // PLAYSIDE change
        ...
        private void UpdatePoints(PCTrail line, float deltaTime)
        {
            ...
            {
				var pos = line.Points[i].Position;
				var vel = EmitVelocityX * ScaleMultiplier;
				line.Points[i].Position = new Vector3(pos.x + World.frameTime * vel, pos.y, pos.z);
